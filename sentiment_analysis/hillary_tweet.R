...
tweets_sentiment2 = searchTwitter("#HillaryClinton", n=5000, lang = "en", since = '2016-08-18', until = '2016-08-25')
...
#write to csv file 
write.csv(df,file="/Users/rohantandon/Desktop/CS_590AC/sentiment/tweets_hillary.txt")

data_tweets<-read.csv("/Users/rohantandon/Desktop/CS_590AC/sentiment/tweets_hillary.txt", stringsAsFactors = FALSE)
...
ggplot(data = sentimentTotals, aes(x = sentiment, y = count)) +
  ...
  xlab("Sentiment") + ylab("Total Count") + ggtitle("Total Sentiment Score for All Tweets-Hillary")
